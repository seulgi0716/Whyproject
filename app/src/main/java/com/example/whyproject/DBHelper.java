...
public class DBHelper extends SQLiteOpenHelper {
    ...
    private static final String CreateTB1 = "CREATE TABLE IF NOT EXISTS PWDTB (_id INTEGER PRIMARY KEY AUTOINCREMENT, SET_VAULE INTEGER, PASSWORD INTEGER);";
    private static final String CreateTB2 = "CREATE TABLE IF NOT EXISTS STRESSTB (_id INTEGER PRIMARY KEY AUTOINCREMENT, S_DATE DATE, S_CONTENT TEXT, S_VAULE INTEGER);";
